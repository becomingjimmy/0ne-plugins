---
description: Marketing execution — emails, posts, campaigns, workshop promotion.
allowed-tools: ["Read", "Bash", "Glob", "AskUserQuestion"]
---

# Marketing — 0ne Premium Skill

Marketing execution — emails, posts, campaigns, workshop promotion.

## Activation Check

**Before anything else, check if the full skill is installed:**

1. Use the Glob tool to check if `~/.0ne/skills/Marketing/SKILL.md` exists.

2. **If the file exists:** Read `~/.0ne/skills/Marketing/SKILL.md` and follow those instructions to fulfill the user's request. You are done with this file — the full skill has everything needed.
...
**Marketing** is a premium skill from [0neOS](https://0neos.com).
...
3. **Activate this skill:**
   ```bash
   bun ~/.0ne/0ne/Tools/skill-install.ts install marketing
   ```
