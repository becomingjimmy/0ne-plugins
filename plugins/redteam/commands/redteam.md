---
description: Adversarial analysis with 32 agents for stress-testing ideas.
allowed-tools: ["Read", "Bash", "Glob", "AskUserQuestion"]
---

# RedTeam — 0ne Premium Skill

Adversarial analysis with 32 agents for stress-testing ideas.

## Activation Check

**Before anything else, check if the full skill is installed:**

1. Use the Glob tool to check if `~/.0ne/skills/RedTeam/SKILL.md` exists.

2. **If the file exists:** Read `~/.0ne/skills/RedTeam/SKILL.md` and follow those instructions to fulfill the user's request. You are done with this file — the full skill has everything needed.
...
**RedTeam** is a premium skill from [0neOS](https://0neos.com).
...
3. **Activate this skill:**
   ```bash
   bun ~/.0ne/0ne/Tools/skill-install.ts install redteam
   ```
